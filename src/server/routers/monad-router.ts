    ...
    .mutation(async ({ c, ctx, input }) => {
      ...
      try {
        ...
        return { type: "RESPONSE", content: text }
          ...
          return { type: "ERROR", content: "Signal Lost. Check Neural Link (API Key)." }
      }
    }),
})
    ...
    start: publicProcedure
        ...
        .mutation(async ({ ctx, input }) => {
            ...
            ;(async () => {
                ...
                // Wait for approval loop would be needed in real system, 
                // but here we rely on the 'approve' endpoint to trigger the next step.
            })()
